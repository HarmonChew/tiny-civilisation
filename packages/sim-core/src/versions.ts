...
export const SIMULATION_BEHAVIOR_VERSION = 4 as const;

/** Version of the authoritative state stored inside SimulationState. */
export const SIMULATION_STATE_VERSION = 4 as const;
...
export const EXPERIMENT_SCHEMA_VERSION = 4 as const;
export const OUTCOME_SCHEMA_VERSION = 3 as const;
export const CAUSAL_EVIDENCE_SCHEMA_VERSION = 4 as const;
