...
export const SIMULATION_STATE_VERSION = 3 as const;
...
export const EXPERIMENT_SCHEMA_VERSION = 3 as const;
export const OUTCOME_SCHEMA_VERSION = 2 as const;
export const CAUSAL_EVIDENCE_SCHEMA_VERSION = 3 as const;
