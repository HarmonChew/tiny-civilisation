...
headless runner, persistence contracts, and tests. The automated rows below are
the immutable release-candidate snapshot recorded at commit `7df0b22`; they are
not current Phase 4.2 counts. This ledger distinguishes those completed
automated observations from the human records that remain outstanding. Phase
4.1 is not release-complete while any human gate remains pending.
...
| Confirmatory usability, five new participants     | No session record is attached; the at-least-four-of-five criterion remains untested.                                                                                                                                                                                                                                           | Pending human gate |

## Automated release result

The frozen calibration and untouched holdout both passed the reviewed classifier
...
Chromium, visual, and three-browser gates all passed at `7df0b22`.
...
unfamiliar participants and cover the carried-forward Phase 2.5 core loop,
Phase 3 scenario comprehension, and Phase 4.1 hydration comprehension. At least
four confirmatory participants must identify who is thirsty, what that creature
