...
- Artifact: `phase-4.2-calibration-v2.json.gz`
- SHA-256: `1b7fd1e4cedcde43a4601d42109dfa7dc2c7a17e1cbce27031a31e9ee41ac52a`
...
| --- | --- | --- | --- | --- | --- |
| `petri-world` | PASS | PASS | PASS | FULL_PHASE_4_2_CALIBRATION_PRESENT | NOT_PRESENT |
| `split-banks` | PASS | PASS | PASS | FULL_PHASE_4_2_CALIBRATION_PRESENT | NOT_PRESENT |
| `scattered-plenty` | PASS | PASS | PASS | FULL_PHASE_4_2_CALIBRATION_PRESENT | NOT_PRESENT |
| `unequal-table` | PASS | PASS | PASS | FULL_PHASE_4_2_CALIBRATION_PRESENT | NOT_PRESENT |
...
| --- | --- | --- | ---: | ---: |
| `petri-world` | ESTABLISHED_SETTLEMENT | PASS | 30 / 64 | 22 |
| `split-banks` | ESTABLISHED_SETTLEMENT | PASS | 13 / 64 | 7 |
| `scattered-plenty` | ESTABLISHED_SETTLEMENT | PASS | 6 / 64 | 2 |
| `unequal-table` | ESTABLISHED_SETTLEMENT | PASS | 3 / 64 | 1 |
...
| `scattered-plenty` | PERSISTENT_PRIVATE_RESERVES | PASS | 90.6% | PHASE_4_2_SCATTERED_LOCAL_PLENTY |
| `scattered-plenty` | SOURCE_BOTTLENECK | PASS | 95.3% | PHASE_4_2_SCATTERED_FINITE_DISTRIBUTED_SOURCES |
| `unequal-table` | PERSISTENT_PRIVATE_RESERVES | PASS | 95.3% | PHASE_4_2_UNEQUAL_CROSS_BANK_SOCIAL_CONTRAST |
...
- Table version: 1
- Corpus validation: FULL_PHASE_4_2_CALIBRATION
...
| --- | --- | --- | --- | ---: | ---: | --- | ---: |
| SOCIAL | `petri-world -> unequal-table` | GROUP_COUNT | PASS | 0.421875 / 0.25 | 0.756174 / 0.5 | ALL_LOCKED_SEEDS; ZERO_IS_OBSERVED | 64 / 64 |
| STORAGE | `petri-world -> unequal-table` | STORED_RESOURCE_UNITS | PASS | 33.75 / 20 | 0.756175 / 0.5 | ALL_LOCKED_SEEDS; ZERO_IS_OBSERVED | 64 / 64 |
| CONFLICT | `petri-world -> scattered-plenty` | ATTACK_EVENT_COUNT | PASS | 2.828125 / 2 | 0.44548 / 0.3 | ALL_LOCKED_SEEDS; ZERO_IS_OBSERVED | 64 / 64 |
| SPATIAL | `scattered-plenty -> unequal-table` | CREATURE_PAIR_DISTANCE_MEDIAN | PASS | 5.1875 / 2 | 2.324537 / 0.5 | ALL_LOCKED_SEEDS; ZERO_IS_OBSERVED | 64 / 64 |
| SETTLEMENT | `petri-world -> unequal-table` | ACTIVE_SHELTER_COUNT | PASS | 0.421875 / 0.25 | 0.756174 / 0.5 | ALL_LOCKED_SEEDS; ZERO_IS_OBSERVED | 64 / 64 |
...
### Frozen SETTLEMENT pair effects
